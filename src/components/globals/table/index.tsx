...
export const DataTable = <T extends object = object>({
  ...
  const FieldOfExpandedRow = (props: {
    ...
    return (
      <li
        className={`grid grid-cols-2 border-b py-2 lg:grid-cols-3 ${
          isEmpty(props.column?.responsive) && 'hidden'
        } antd-${props.column?.responsive?.[0]}:hidden`}
      >
        <div className='justify-left flex items-center lg:col-span-2'>
        ...
        <div className='justify-left items-center lg:flex'>{props.body}</div>
      </li>
    )
  }
  ...
  return (
    <React.Fragment>
      {
        // !! DO NOT REMOVE IT
        <div className='antd-sx:hidden hidden antd-sm:hidden antd-md:hidden antd-lg:hidden antd-xl:hidden antd-xxl:hidden'></div>
