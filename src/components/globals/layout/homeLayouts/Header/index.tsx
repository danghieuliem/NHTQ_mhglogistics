...
const UserControl = ({ user, setOpenModal, firstPage, connection }) => {
  ...
  return (
    <div className={styles.userControl}>
      {!user?.Id ? (
        <div className='login-user ml-4 flex items-center justify-end'>
          <a
                  ...
                  <span className={styles.headInfo}>
                    <span className='flex items-center justify-between'>
                      ...
                      <Tooltip title='Cấp độ VIP của bạn'>
                        <span className='ml-4 rounded-[4px] bg-main py-1 px-2 text-[10px] font-bold leading-[initial] text-white'>
                          VIP {user?.LevelId}
                        </span>
                      </Tooltip>
                    </span>
                    <Tooltip
                      ...
                      className='flex items-center justify-between text-main'
                    >
        ...
        >
          <div
            className={clsx(
              'group relative ml-4  cursor-pointer',
              styles.hoverInfo,
            )}
          >
            {/* <Link href={firstPage ? firstPage : "/user"}> */}
            <span className='text login-user flex items-center font-semibold uppercase !text-main'>
              <i className='text fas fa-user mr-2 text-main'></i>
          ...
          <div className='container'>
            <div className={styles.headerTopInner}>
              <div className={styles.headerTopLeft}>
                ...
                <div className='mr-3 hidden w-fit md:hidden xl:flex'>
        ...
        <div className={styles.headerBottom}>
          <div className='container'>
            <div className='flex items-center justify-between '>
              ...
              <div className='xl:justify-right flex w-full items-center  justify-between lg:w-full lg:justify-center xl:w-fit'>
