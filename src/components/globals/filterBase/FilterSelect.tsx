...
export const FilterSelect = <TFieldValues extends object = object>({
  ...
  return (
    <div className='relative'>
      <div className='!bg-transparent py-[2px] text-[10px] font-bold'>
        {label}
      </div>
      <div>
        <Select
  ...
  return (
    <components.DropdownIndicator {...rest}>
      <span onClick={handleSubmit} className='h-full cursor-pointer px-3'>
        <i className='fal fa-search text-base text-[#6b6f82]'></i>
      </span>
  ...
  return (
    <components.DropdownIndicator {...props}>
      <span className='h-full cursor-pointer px-3'>
        <i className='far fa-chevron-down text-base text-[#6b6f82]'></i>
      </span>
    </components.DropdownIndicator>
  )
}
