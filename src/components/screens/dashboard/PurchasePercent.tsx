...
const PercentOrder = () => {
  ...
  return (
    <div className='tableBox flex h-full w-full flex-col justify-between'>
...
export const PurchasePercent = () => {
  return (
    <div className='hidden w-full gap-4 xs:grid md:grid-cols-3'>
      <PercentOrderMemo />
