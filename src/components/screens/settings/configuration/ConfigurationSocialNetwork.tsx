...
export const ConfigurationSocialNetwork: FC<TProps<TConfig2>> = ({
  control,
  data,
}) => {
  return (
                  ...
                  Modal.info({
                    ...
                    content: (
                      <div>
                        ...
                        <div className='py-1'>
                          Bước 2: Nhập địa chỉ và chọn "Get Code"
                        </div>
                        <div className='py-1'>
                          Bước 3: Chọn tab "Iframe" và copy src
                        </div>
                        <div className='font-[10px] pt-2 text-red'>
                          NOTE: Chỉ copy src
                        </div>
                      </div>
                    ),
                  ...
                  Modal.info({
                    ...
                    content: (
                      <div>
                        ...
                        <div className='py-1'>
                          Bước 2: Nhập địa chỉ và chọn share
                        </div>
                        <div className='py-1'>
                          Bước 3: Chọn tab 'Embed a map' và copy src
                        </div>
                        <div className='font-[10px] pt-2 text-red'>
                          NOTE: Chỉ copy src
                        </div>
