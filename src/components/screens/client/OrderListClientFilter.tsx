...
export const OrderListClientFilter: React.FC<TProps> = ({
  handleFilter,
  handleExporTExcel,
}) => {
  ...
  return (
    <div className='mb-4 mt-6 grid-cols-3 gap-4 lg:grid'>
      ...
      <div className='col-span-3 items-center justify-end lg:flex'>
        <FilterCheckbox
