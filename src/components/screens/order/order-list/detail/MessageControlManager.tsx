...
export const MessageControlManager = ({ clientId, mainOrderId }) => {
  ...
  return (
    <>
      <div
        className={clsx(
          'fixed bottom-[32px] right-[80px] z-[9999] flex h-[440px] grid-cols-2 flex-row-reverse',
          {
      ...
      >
        <div className='col-span-1 w-[340px]'>
          <div className={clsx('z-100 duration-300 ease-linear')}>
            <ChatBox
      ...
      <div
        className={clsx(
          'fixed bottom-[32px] right-[400px] z-[9999] flex h-[440px] grid-cols-2 flex-row-reverse',
          {
