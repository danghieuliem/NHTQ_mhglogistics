  ...
  return (
    <div className='grid grid-cols-2 gap-4'>
      <div className='col-span-2'>
        <span className='text-md mb-2 block border-b border-[#f8dfd5] font-bold uppercase text-[#595857]'>
          DANH SÁCH NGÂN HÀNG
        </span>
        <div className='grid gap-1 xs:grid-cols-2 lg:grid-cols-3'>
      ...
      <div className='col-span-2'>
        <div className='grid grid-cols-1 gap-3'>
          <div className='col-span-2 flex items-center justify-between border-b border-[#f8dfd5] pb-2'>
            <span className='text-md mb-[-2rem] block font-bold uppercase text-[#595857]'>
          ...
          <div className='col-span-2 grid grid-cols-1 gap-2 xs:grid-cols-2'>
            <FormInput
              control={control}
              name='BankInfo'
