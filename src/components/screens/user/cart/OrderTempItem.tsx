    ...
    <>
      {canUpdate ? (
        <input
          ...
          placeholder=''
          disabled={disabled}
          className='h-[28px] w-[60px] !rounded-[6px] border !border-[#c4c4c4] !text-center'
          onChange={(val) => {
      ...
      {data?.map((item, index) => (
        ...
        >
          <div
            ...
            key={`${item?.Id}-${item?.OrderShopTempId}-${item?.TitleOrigin}`}
          >
            <div className='col-span-3 font-bold text-[#6A6A6A]'>
              {item?.TitleOrigin}
            </div>
            <div
              className={clsx(
            ...
            <div className='col-span-2 grid h-fit grid-cols-2 gap-1'>
              <div className='col-span-2 flex items-start justify-between'>
                <span className='mr-2 w-[100px] font-bold leading-[inital]'>
                  Thuộc tính:{' '}
                </span>
                <span
                  className='max-w-[130px] text-right text-xs text-label'
        ...
        render: (_, record, index) => {
          return (
            <div className='grid grid-cols-4 gap-1'>
              ...
              <div className='col-span-3 flex flex-col gap-1 pl-1 text-black'>
                ...
                <span className='flex items-start justify-between'>
                  ...
                  <span
                    className='max-w-[160px] text-right text-xs text-label'
                    style={{ wordBreak: 'keep-all' }}
                  >
                    {record?.Property}
                  </span>
