...
export const ReceiveInfoForm: React.FC<TProps> = ({
  ...
  return (
    <div className='grid grid-cols-2 gap-2'>
      <span className='col-span-full text-[18px] font-bold text-[#1582F5]'>
        Thông tin nhận hàng
      </span>
      <div className='col-span-full grid h-fit gap-2 sm:grid-cols-3'>
      ...
      <div className='col-span-full grid h-fit gap-2 sm:grid-cols-4'>
        <FormInput
          name='FullName'
