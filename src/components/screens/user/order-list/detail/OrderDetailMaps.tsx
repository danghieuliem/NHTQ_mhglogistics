        ...
        >
          ...
          {location1Popover && (
            <InfoWindow onCloseClick={handleLocation1Popover}>
              <div>
                <div className='text-base font-bold text-[#000]'>Đông Hưng</div>
        ...
        >
          ...
          {location2Popover && (
            <InfoWindow onCloseClick={handleLocation2Popover}>
              <div>
                <div className='text-base font-bold text-[#000]'>Hà Nội</div>
                <div className='text-sm'>Các mã vận đơn hiện có: 5</div>
              </div>
            </InfoWindow>
          )}
...
export const OrderDetailMaps: React.FC<any> = ({ data }) => {
  return (
    <div className='tableBox relative'>
      <MyMap
      ...
      />
      <div className='absolute left-20 right-20 top-10 rounded-3xl bg-[#f8f0e8cc] p-6'>
