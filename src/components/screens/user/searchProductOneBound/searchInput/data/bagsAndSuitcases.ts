const BagsAndSuitcases = {
  Img: '/catalogueImages/school-bag.png',
  Title: 'Túi xách, vali',
  Children: [
    {
      Title: 'Túi, ví nam',
      Children: [
        { Title: 'Túi xách tay nam', Value: '男士手提包' },
        { Title: 'Túi đeo chéo nam', Value: '男士斜挎包' },
    ...
    },
    {
      Title: 'Túi, ví nữ',
      Children: [
        { Title: 'Túi xách tay nữ', Value: '女士手提包' },
        { Title: 'Túi đeo chéo nữ', Value: '女士斜挎包' },
