...
import { useHookRapidAPI } from './hookRapidAPI'
import { useHookOnebound } from './hookOnebound'

const DetailSearchPage = () => {
  const { layoutLeftData, data, previewImg, handleChangePreview, ecsite } =
    useHookRapidAPI()
        ...
        <div className='tableBox mx-auto flex w-full max-w-[1200px] flex-row flex-wrap justify-between gap-4'>
          <div className='w-full md:w-[36%]'>
            <div className='w-full'>
              <LayoutLeft item={layoutLeftData} attributeImage={previewImg} />
            </div>
          </div>
