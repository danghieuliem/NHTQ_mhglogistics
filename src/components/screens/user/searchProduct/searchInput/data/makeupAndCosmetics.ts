const MakeupAndCosmetics = {
  Img: '/catalogueImages/makeup.png',
  Title: 'Trang điểm, mỹ phẩm',
  Children: [
    {
      Title: 'Nước hoa trang điểm',
      Children: [
        { Title: 'Kem BB', Value: 'BB霜' },
        { Title: 'Kem chống nắng', Value: '防晒霜' },
        { Title: 'Kem BB nén', Value: '固体BB霜' },
        { Title: 'Phấn nền trang điểm', Value: '粉底' },
        { Title: 'Son môi', Value: '唇膏' },
    ...
    },
    {
      Title: 'Chăm sóc da',
      Children: [
        { Title: 'Tẩy trang', Value: '卸妆' },
        { Title: 'Sữa rửa mặt', Value: '洗面奶' },
        { Title: 'Mặt nạ dưỡng da', Value: '面膜' },
    ...
    },
    {
      ...
      Children: [
        { Title: 'Bộ cọ trang điểm', Value: '化妆刷套装' },
        { Title: 'Mút trang điểm', Value: '化妆海绵' },
    ...
    },
    {
      ...
      Children: [
        { Title: 'Keo dán móng', Value: '美甲胶水' },
        { Title: 'Sơn móng tay', Value: '指甲油' },
        { Title: 'Kềm cắt móng tay', Value: '指甲刀' },
    ...
    },
    {
      ...
      Children: [
        { Title: 'sản phẩm chăm sóc da', Value: '护肤品' },
        { Title: 'nước rửa tay', Value: '洗手液' },
        { Title: 'miếng dán chân', Value: '足贴' },
        { Title: 'băng vệ sinh', Value: '卫生巾' },
        { Title: 'dầu gội đầu', Value: '洗发水' },
        { Title: 'dầu xả', Value: '护发素' },
        { Title: 'sữa dưỡng thể', Value: '身体乳' },
    ...
    },
    {
      ...
      Children: [
        { Title: 'khăn giấy', Value: '纸巾' },
        { Title: 'giẩy rút', Value: '纸巾盒' },
