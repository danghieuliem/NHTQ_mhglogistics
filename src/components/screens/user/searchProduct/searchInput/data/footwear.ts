const Footwear = {
  Img: '/catalogueImages/high-heels.png',
  Title: 'Giày, dép',
  Children: [
    {
      Title: 'Giày nữ',
      Children: [
        { Title: 'GIÀY NỮ', Value: '女鞋' },
        { Title: 'Bốt cố ngắn gót cao', Value: '短筒高跟靴' },
        { Title: 'Giày cao gót mũi nhọn', Value: '尖头高跟鞋' },
        { Title: 'Giày da PU', Value: 'PU皮鞋' },
    ...
    },
    {
      ...
      Children: [
        { Title: 'Giày dép đi trong nhà', Value: '室内拖鞋' },
        { Title: 'Dép nhựa', Value: '塑料拖鞋' },
    ...
    },
    {
      Title: 'Giày nam',
      Children: [
        { Title: 'Giày nam', Value: '男靴' },
        { Title: 'Bốt da nam', Value: '男士皮靴' },
